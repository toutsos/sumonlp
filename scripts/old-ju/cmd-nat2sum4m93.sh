...
python -m nmt.nmt \
  ...
  --batch_size=128 \
  --src=nat --tgt=sum1 \
  --vocab_prefix=/home/mptp/big2/adamp/v2/vocab \
  --train_prefix=/home/mptp/big2/adamp/v2/train \
  --dev_prefix=/home/mptp/big2/adamp/v2/dev \
  --test_prefix=/home/mptp/big2/adamp/v2/test \
  --out_dir=/home/mptp/nmt1/tg1/model93 \
  --num_train_steps=18000 \
  --steps_per_stats=2000 \
  --steps_per_external_eval=2000 \
  --num_layers=2 \
  --dropout=0.2 \
  --metrics=bleu > /home/mptp/nmt1/tg1/train.log12kb93
#  --beam_width=10 \
